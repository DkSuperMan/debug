...
3.cycript -p 2902
4.?expand
5.[[UIApp keyWindow] recursiveDescription]
...
六、UIAlertView
	UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"提示" message:@"HOOK_SpringBoard" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
	[alert show];
	[alert release];